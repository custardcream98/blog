...
function IntroduceSection() {
  return (
    <S.Section>
      ...
      <IntroduceP>
        <strong>동료와 함께 성장하는 개발자</strong>입니다. 95명 규모의 프론트엔드 채널을 직접
        운영하며, 주 1회 이상 최신 기술·아키텍처 아티클을 큐레이션해 공유합니다. 회의·코드리뷰에서도
        문제를 적극적으로 제기하고 대안을 제시해 왔습니다. 덕분에 다면평가에서 &quot;기술적 고민을
        깊이 하고 학습 내용을 적극 공유&quot;, &quot;어려움에 처한 동료를 먼저 돕고 팀워크를
        강화&quot;, &quot;호기심과 개선 의지가 탁월&quot;하다는 피드백을 받았습니다.
      </IntroduceP>
