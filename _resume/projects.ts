...
const projects: Project[] = [
  {
    ...
    descriptions: [
      "1주간 연습용으로 조금 개발해보는 프로젝트였으나, 두 명이서 추가로 개발을 진행해 완성 및 배포했습니다. CSO님을 비롯한 사내 임직원 분들께 좋은 반응을 얻었습니다.",
  ...
  },
  {
    ...
    team: "4인 프로젝트 (기여도 40%)",
    shortDescription:
      "스냅 사진사와 이용자를 매칭하는 SNS 서비스입니다. 네 명의 프론트엔드 개발자로 구성된 팀에서 리더를 맡았으며, Live Share 등의 툴을 사용해 페어 프로그래밍을 주로 진행했습니다. TypeScript에 익숙치 않은 팀원들을 위해 JavaScript를 사용하는 대신, JSDoc을 적극적으로 활용해 개발 경험을 향상시키고자 노력했습니다.",
    descriptions: [
      "서버와의 비동기 통신시 사용되는 반복되는 패턴을 분리, useAPI 커스텀 훅을 설계 및 개발해 팀 내에서 좋은 평가를 받았습니다.",
  ...
  },
  {
    ...
    team: "개인 프로젝트",
    shortDescription:
      "저만의 색깔을 나타낼 수 있도록 모든 부분을 직접 개발한 블로그입니다. SEO를 고려해 SSG가 가능한 Next.js를 사용했고, 댓글 등록 알람을 받고싶어 메일링 API를 개발해 적용하기도 했습니다. 지속적으로 리팩토링하며 컴포넌트 설계의 테스트베드로 활용하고 있습니다.",
    descriptions: [
      "remark를 활용해 마크다운으로 작성한 포스트를 정적 웹사이트로 빌드합니다. ",
      "Lighthouse 기준 Accessibility, SEO 점수 100점을 유지하고 있습니다. 그 결과 Google Search Console 기준 총 노출수 11,330회, 총 클릭수 1,100회, 평균 게재순위 14.6위를 달성했습니다.",
      "블로그 내 게시물 검색 기능을 구현했으며, API Call 최적화 및 어뷰징 방지를 위해 디바운싱을 적용하는 등 지속적으로 기능을 개선 및 추가하고 있습니다.",
  ...
  },
  {
    ...
    descriptions: [
      "슬라이더를 움직일 때마다 유효성을 검증하고, 유효하지 않은 경우 GNB에 표현 및 해당 문항으로 이동할 수 있는 링크 제공을 위해 recoil을 활용, 전역 상태를 관리했습니다.",
  ...
  },
  {
    ...
    descriptions: [
      ...
      "거래소별로 상이한 API 명세에 대응하기 위한 normalizer를 구조적으로 설계했습니다.",
      "NFT 프로젝트 커뮤니티 관리를 위한 이벤트 기능, NFT 정보 검색 및 보유중인 NFT 조회 기능을 탑재한 디스코드 봇을 개발해 약 2800여 명의 사용자가 있는 디스코드 서버에서 실사용됐습니다.",
    ],
    links: [
      {
        name: "카카오톡 봇 기능 설명",
