import { ResumeSectionData } from "types/resume";
...
const educations: ResumeSectionData[] = [
  {
    ...
    points: [
      ...
      "회고조 조장, 팀 프로젝트 리더로서 활동하며 Soft Skill을 발휘했습니다. 지식을 나누기 위해 59명의 동료들에게 리액트로 투두 개발하기 특강을 진행하고, 동료가 마주친 이슈를 함께 해결해나가는 '칭구칭긔들' 스터디를 리드하기도 했습니다.",
    ],
    links: [
      {
        name: "투두 개발하기 특강",
